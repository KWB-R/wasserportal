...
#> Writing 'stations_groundwater_level.csv' ... ok. (0.18 secs) 
...
#> Importing 'groundwater.level' data (1/2) ... ok. (11.41 mins) 
#> Importing 'groundwater.quality' data (2/2) ... ok. (2.69 mins)

files <- wasserportal::list_timeseries_data_to_zip(gw_data_list)
#> Writing 'groundwater_level.zip' ... ok. (15.37 secs) 
#> Writing 'groundwater_quality.zip' ... ok. (1.26 secs)
