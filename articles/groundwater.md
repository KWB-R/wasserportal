...
#> Writing 'stations_groundwater_level.csv' ... ok. (0.20 secs) 
...
#> Importing 'groundwater.level' data (1/2) ... ok. (10.02 mins) 
#> Importing 'groundwater.quality' data (2/2) ... ok. (1.79 mins)

files <- wasserportal::list_timeseries_data_to_zip(gw_data_list)
#> Writing 'groundwater_level.zip' ... ok. (13.17 secs) 
