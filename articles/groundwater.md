...
#> Importing 'groundwater.level' data (1/2) ... ok. (9.41 mins) 
#> Importing 'groundwater.quality' data (2/2) ... ok. (1.77 mins)

files <- wasserportal::list_timeseries_data_to_zip(gw_data_list)
#> Writing 'groundwater_level.zip' ... ok. (11.64 secs) 
