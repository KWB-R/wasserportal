...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (6.79 secs)
...
#> Importing 'groundwater.level' data (1/2) ... ok. (10.48 mins) 
#> Importing 'groundwater.quality' data (2/2) ... ok. (2.65 mins)

files <- wasserportal::list_timeseries_data_to_zip(gw_data_list)
#> Writing 'groundwater_level.zip' ... ok. (13.49 secs) 
#> Writing 'groundwater_quality.zip' ... ok. (1.24 secs)
...
#> 'data.frame':    1114 obs. of  12 variables:
