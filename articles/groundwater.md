...
#> Writing 'stations_groundwater_level.csv' ... ok. (0.19 secs) 
...
#> Importing 'groundwater.level' data (1/2) ... ok. (12.61 mins) 
#> Importing 'groundwater.quality' data (2/2) ... ok. (2.20 mins)

files <- wasserportal::list_timeseries_data_to_zip(gw_data_list)
#> Writing 'groundwater_level.zip' ... ok. (11.47 secs) 
#> Writing 'groundwater_quality.zip' ... ok. (1.04 secs)
