...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (5.80 secs)

is_gw <- stringr::str_detect(names(stations_list), "groundwater")

files <- wasserportal::list_masters_data_to_csv(stations_list[is_gw])
#> Writing 'stations_groundwater_level.csv' ... ok. (0.16 secs) 
...
#> Importing 'groundwater.level' data (1/2) ... ok. (12.48 mins) 
#> Importing 'groundwater.quality' data (2/2) ... ok. (1.84 mins)

files <- wasserportal::list_timeseries_data_to_zip(gw_data_list)
#> Writing 'groundwater_level.zip' ... ok. (11.23 secs) 
#> Writing 'groundwater_quality.zip' ... ok. (1.02 secs)
