...
#> Importing 'groundwater.level' data (1/2) ... ok. (12.81 mins) 
#> Importing 'groundwater.quality' data (2/2) ... ok. (2.93 mins)

files <- wasserportal::list_timeseries_data_to_zip(gw_data_list)
#> Writing 'groundwater_level.zip' ... ok. (14.78 secs) 
