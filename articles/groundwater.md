...
#> Importing 'groundwater.level' data (1/2) ... ok. (10.10 mins) 
#> Importing 'groundwater.quality' data (2/2) ... ok. (3.23 mins)

files <- wasserportal::list_timeseries_data_to_zip(gw_data_list)
#> Writing 'groundwater_level.zip' ... ok. (11.30 secs) 
