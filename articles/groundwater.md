...
#> Importing 'groundwater.level' data (1/2) ... ok. (9.99 mins) 
#> Importing 'groundwater.quality' data (2/2) ... ok. (2.18 mins)

files <- wasserportal::list_timeseries_data_to_zip(gw_data_list)
#> Writing 'groundwater_level.zip' ... ok. (15.24 secs) 
#> Writing 'groundwater_quality.zip' ... ok. (1.38 secs)
