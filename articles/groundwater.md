...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (7.03 secs)
...
#> Importing 'groundwater.level' data (1/2) ... ok. (9.97 mins) 
#> Importing 'groundwater.quality' data (2/2) ... ok. (2.73 mins)

files <- wasserportal::list_timeseries_data_to_zip(gw_data_list)
#> Writing 'groundwater_level.zip' ... ok. (11.28 secs) 
