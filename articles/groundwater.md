...
#> Importing 'groundwater.level' data (1/2) ... ok. (12.33 mins) 
#> Importing 'groundwater.quality' data (2/2) ... ok. (3.02 mins)

files <- wasserportal::list_timeseries_data_to_zip(gw_data_list)
#> Writing 'groundwater_level.zip' ... ok. (11.29 secs) 
