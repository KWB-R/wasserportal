...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (8.50 secs)
...
#> Importing 'groundwater.level' data (1/2) ... ok. (9.96 mins) 
#> Importing 'groundwater.quality' data (2/2) ... ok. (1.87 mins)

files <- wasserportal::list_timeseries_data_to_zip(gw_data_list)
#> Writing 'groundwater_level.zip' ... ok. (14.64 secs) 
#> Writing 'groundwater_quality.zip' ... ok. (1.32 secs)
