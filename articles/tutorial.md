...
#> Importing master data for 893 stations from Wasserportal Berlin ... ok. (5.68 mins)
```
...
80.02 percent of all considered 806 groundwater level monitoring
...
groundwater levels. However, only 80.02 percent are indicate
