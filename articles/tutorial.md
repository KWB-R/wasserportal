...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (9.54 secs)
str(stations, 2)
#> List of 2
...
#> Importing master data for 893 stations from Wasserportal Berlin ... ok. (8.52 mins)
```
...
80.1 percent of all considered 819 groundwater level monitoring stations
containing `classification` data (out of 893 provided by SenWeb)
indicate `below normal` (extrem niedrig, sehr niedrig, niedrig)
groundwater levels. However, only 80.1 percent are indicate
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (2.03 mins)
```
