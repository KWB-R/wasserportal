...
#> Importing master data for 890 stations from Wasserportal Berlin ... ok. (8.39 mins)
```
...
50.06 percent of all considered 811 groundwater level monitoring
...
groundwater levels. However, only 50.06 percent are indicate
