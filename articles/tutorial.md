...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (9.43 secs)
str(stations, 2)
#> List of 2
...
75.85 percent of all considered 820 groundwater level monitoring
...
groundwater levels. However, only 75.85 percent are indicate
