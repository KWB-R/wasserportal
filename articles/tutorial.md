...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (8.87 secs)
str(stations, 2)
#> List of 2
...
#>   ..$ groundwater.level                 : tibble [888 × 11] (S3: tbl_df/tbl/data.frame)
#>   ..$ groundwater.quality               : tibble [208 × 10] (S3: tbl_df/tbl/data.frame)
#>  $ crosstable   : tibble [1,111 × 12] (S3: tbl_df/tbl/data.frame)
```
...
#> Importing master data for 888 stations from Wasserportal Berlin ... ok. (9.36 mins)
```
...
stations containing `classification` data (out of 888 provided by
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (2.21 mins)
```
