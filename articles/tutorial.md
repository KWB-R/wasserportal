...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (7.99 secs)
str(stations, 2)
#> List of 2
...
#> Importing master data for 891 stations from Wasserportal Berlin ... ok. (9.12 mins)
```
...
66.13 percent of all considered 803 groundwater level monitoring
...
groundwater levels. However, only 66.13 percent are indicate
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (2.64 mins)
```
