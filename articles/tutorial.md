...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (6.92 secs)
str(stations, 2)
#> List of 2
...
57.58 percent of all considered 752 groundwater level monitoring
...
groundwater levels. However, only 57.58 percent are indicate
