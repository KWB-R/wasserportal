...
#> Importing master data for 889 stations from Wasserportal Berlin ... ok. (8.54 mins)
```
...
54.91 percent of all considered 774 groundwater level monitoring
...
groundwater levels. However, only 54.91 percent are indicate
