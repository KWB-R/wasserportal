...
#> Importing master data for 894 stations from Wasserportal Berlin ... ok. (9.34 mins)
```
...
83.8 percent of all considered 815 groundwater level monitoring stations
containing `classification` data (out of 894 provided by SenWeb)
indicate `below normal` (extrem niedrig, sehr niedrig, niedrig)
groundwater levels. However, only 83.8 percent are indicate
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (2.30 mins)
```
