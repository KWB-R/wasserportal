...
57.94 percent of all considered 749 groundwater level monitoring
...
groundwater levels. However, only 57.94 percent are indicate
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (1.40 mins)
```
