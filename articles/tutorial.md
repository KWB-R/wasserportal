...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (8.76 secs)
str(stations, 2)
#> List of 2
...
80.51 percent of all considered 821 groundwater level monitoring
...
groundwater levels. However, only 80.51 percent are indicate
