...
#> Importing master data for 891 stations from Wasserportal Berlin ... ok. (8.44 mins)
```
...
66.16 percent of all considered 792 groundwater level monitoring
...
groundwater levels. However, only 66.16 percent are indicate
