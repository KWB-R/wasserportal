...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (7.13 secs)
str(stations, 2)
#> List of 2
...
#> Importing master data for 891 stations from Wasserportal Berlin ... ok. (7.01 mins)
```
...
64.35 percent of all considered 805 groundwater level monitoring
...
groundwater levels. However, only 64.35 percent are indicate
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (1.64 mins)
```
