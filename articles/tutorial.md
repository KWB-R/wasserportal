...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (8.78 secs)
str(stations, 2)
#> List of 2
...
#> Importing master data for 893 stations from Wasserportal Berlin ... ok. (8.21 mins)
```
...
73.89 percent of all considered 812 groundwater level monitoring
...
groundwater levels. However, only 73.89 percent are indicate
