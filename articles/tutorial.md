...
#> Importing master data for 894 stations from Wasserportal Berlin ... ok. (9.41 mins)
```
...
84.13 percent of all considered 813 groundwater level monitoring
...
groundwater levels. However, only 84.13 percent are indicate
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (2.18 mins)
```
