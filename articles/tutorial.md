...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (8.03 secs)
str(stations, 2)
#> List of 2
...
#> Importing master data for 894 stations from Wasserportal Berlin ... ok. (8.93 mins)
```
...
86.6 percent of all considered 821 groundwater level monitoring stations
containing `classification` data (out of 894 provided by SenWeb)
indicate `below normal` (extrem niedrig, sehr niedrig, niedrig)
groundwater levels. However, only 86.6 percent are indicate
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (2.91 mins)
```
