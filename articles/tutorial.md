...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (4.83 secs)
str(stations, 2)
#> List of 2
...
#> Importing master data for 891 stations from Wasserportal Berlin ... ok. (7.25 mins)
#> Failed fetching data from the following URLs:
#> [1] "https://wasserportal.berlin.de/station.php?anzeige=i&thema=gws&station=4588"
```
...
59.43 percent of all considered 769 groundwater level monitoring
...
groundwater levels. However, only 59.43 percent are indicate
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (1.33 mins)
```
