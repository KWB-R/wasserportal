...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (14.50 secs)
str(stations, 2)
#> List of 2
...
#> Importing master data for 894 stations from Wasserportal Berlin ... ok. (18.53 mins)
```
...
85.12 percent of all considered 813 groundwater level monitoring
stations containing `classification` data (out of 894 provided by
SenWeb) indicate `below normal` (extrem niedrig, sehr niedrig, niedrig)
groundwater levels. However, only 85.12 percent are indicate
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (4.03 mins)
```
