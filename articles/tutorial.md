...
#> Importing master data for 891 stations from Wasserportal Berlin ... ok. (8.21 mins)
```
...
60.42 percent of all considered 768 groundwater level monitoring
...
groundwater levels. However, only 60.42 percent are indicate
