...
#> Importing master data for 890 stations from Wasserportal Berlin ... ok. (8.83 mins)
```
...
53.52 percent of all considered 781 groundwater level monitoring
...
groundwater levels. However, only 53.52 percent are indicate
