...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (7.05 secs)
str(stations, 2)
#> List of 2
...
#> Importing master data for 893 stations from Wasserportal Berlin ... ok. (7.26 mins)
```
...
80.52 percent of all considered 806 groundwater level monitoring
...
groundwater levels. However, only 80.52 percent are indicate
