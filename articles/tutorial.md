...
#> Importing master data for 893 stations from Wasserportal Berlin ... ok. (6.15 mins)
```
...
72.39 percent of all considered 804 groundwater level monitoring
...
groundwater levels. However, only 72.39 percent are indicate
