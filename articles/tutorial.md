...
#> Importing master data for 893 stations from Wasserportal Berlin ... ok. (9.15 mins)
```
...
73.01 percent of all considered 815 groundwater level monitoring
...
groundwater levels. However, only 73.01 percent are indicate
