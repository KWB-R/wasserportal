...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (8.26 secs)
str(stations, 2)
#> List of 2
...
#> Importing master data for 893 stations from Wasserportal Berlin ... ok. (34.73 mins)
```
...
81 percent of all considered 821 groundwater level monitoring stations
containing `classification` data (out of 893 provided by SenWeb)
indicate `below normal` (extrem niedrig, sehr niedrig, niedrig)
groundwater levels. However, only 81 percent are indicate `above normal`
(hoch, sehr hoch, extrem hoch) groundwater levels.
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (9.67 mins)
```
