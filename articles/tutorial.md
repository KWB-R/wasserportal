...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (10.34 secs)
str(stations, 2)
#> List of 2
...
#> Importing master data for 890 stations from Wasserportal Berlin ... ok. (9.24 mins)
```
...
52.3 percent of all considered 805 groundwater level monitoring stations
containing `classification` data (out of 890 provided by SenWeb)
indicate `below normal` (extrem niedrig, sehr niedrig, niedrig)
groundwater levels. However, only 52.3 percent are indicate
