...
#> Importing master data for 891 stations from Wasserportal Berlin ... ok. (8.53 mins)
```
...
66.08 percent of all considered 799 groundwater level monitoring
...
groundwater levels. However, only 66.08 percent are indicate
