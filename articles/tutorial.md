...
#> Importing master data for 891 stations from Wasserportal Berlin ... ok. (8.39 mins)
```
...
59.56 percent of all considered 769 groundwater level monitoring
...
groundwater levels. However, only 59.56 percent are indicate
