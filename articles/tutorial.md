...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (5.52 secs)
str(stations, 2)
#> List of 2
...
#> Importing master data for 893 stations from Wasserportal Berlin ... ok. (5.70 mins)
```
...
80.39 percent of all considered 821 groundwater level monitoring
...
groundwater levels. However, only 80.39 percent are indicate
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (1.50 mins)
```
