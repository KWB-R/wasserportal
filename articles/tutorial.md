...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (7.63 secs)
str(stations, 2)
#> List of 2
...
#> Importing master data for 894 stations from Wasserportal Berlin ... ok. (9.13 mins)
```
...
85.22 percent of all considered 812 groundwater level monitoring
...
groundwater levels. However, only 85.22 percent are indicate
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (2.27 mins)
```
