...
#> Importing master data for 890 stations from Wasserportal Berlin ... ok. (6.12 mins)
```
...
50.56 percent of all considered 797 groundwater level monitoring
...
groundwater levels. However, only 50.56 percent are indicate
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (1.74 mins)
```
