...
#> Importing master data for 890 stations from Wasserportal Berlin ... ok. (9.74 mins)
```
...
53.45 percent of all considered 782 groundwater level monitoring
...
groundwater levels. However, only 53.45 percent are indicate
