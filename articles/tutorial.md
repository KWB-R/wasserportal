...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (6.74 secs)
str(stations, 2)
#> List of 2
...
#> Importing master data for 889 stations from Wasserportal Berlin ... ok. (17.63 mins)
#> Failed fetching data from the following URLs:
#> [1] "https://wasserportal.berlin.de/station.php?anzeige=i&thema=gws&station=149" 
#> [2] "https://wasserportal.berlin.de/station.php?anzeige=i&thema=gws&station=6097"
```
...
59.41 percent of all considered 749 groundwater level monitoring
...
groundwater levels. However, only 59.41 percent are indicate
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (1.43 mins)
```
