...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (11.14 secs)
str(stations, 2)
#> List of 2
...
#> Importing master data for 890 stations from Wasserportal Berlin ... ok. (8.99 mins)
#> Failed fetching data from the following URLs:
#> [1] "https://wasserportal.berlin.de/station.php?anzeige=i&thema=gws&station=516" 
#> [2] "https://wasserportal.berlin.de/station.php?anzeige=i&thema=gws&station=7110"
```
...
49.56 percent of all considered 801 groundwater level monitoring
...
groundwater levels. However, only 49.56 percent are indicate
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (2.25 mins)
```
