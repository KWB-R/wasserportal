...
#> Importing master data for 890 stations from Wasserportal Berlin ... ok. (7.39 mins)
```
...
52.1 percent of all considered 810 groundwater level monitoring stations
containing `classification` data (out of 890 provided by SenWeb)
indicate `below normal` (extrem niedrig, sehr niedrig, niedrig)
groundwater levels. However, only 52.1 percent are indicate
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (1.79 mins)
```
