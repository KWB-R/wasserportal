...
#> Importing master data for 889 stations from Wasserportal Berlin ... ok. (8.52 mins)
#> Failed fetching data from the following URLs:
#> [1] "https://wasserportal.berlin.de/station.php?anzeige=i&thema=gws&station=7041"
#> [2] "https://wasserportal.berlin.de/station.php?anzeige=i&thema=gws&station=7042"
```
...
56.84 percent of all considered 760 groundwater level monitoring
...
groundwater levels. However, only 56.84 percent are indicate
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (1.67 mins)
```
