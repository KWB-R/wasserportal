...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (7.90 secs)
str(stations, 2)
#> List of 2
...
71.06 percent of all considered 805 groundwater level monitoring
...
groundwater levels. However, only 71.06 percent are indicate
