...
cat(paste0(
  sprintf("- [%s](%s/%s)", urls$gh_wasserportal, files, files),
  collapse = "\n\n"
))
```
...
gw_data_list <- wasserportal::get_groundwater_data(stations, debug = FALSE)
...
cat(paste0(
  sprintf("- [%s](%s/%s)", files, urls$gh_wasserportal, files),
  collapse = "\n\n"
))
```
