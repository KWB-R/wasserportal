...
files <- wasserportal::list_data_to_csv_or_zip(data_list = stations$overview_list[is_gw], 
                                               file_prefix = "stations")
...
gw_data_list <- wasserportal::get_groundwater_data(stations,
                                                   debug = FALSE)


files <- wasserportal::list_data_to_csv_or_zip(gw_data_list, 
                                               to_zip = TRUE)
files
