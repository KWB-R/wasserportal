...
More information on the groundwater level stations, such as the coordinates of 
the wells (master data), can be found if you follow the web link (URL) that is
...
#### Download and Plot Data for One Station
...
#### Download and Plot Data for Multiple Stations
