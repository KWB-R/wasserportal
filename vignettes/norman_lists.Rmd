...
vignette: >
 %\VignetteIndexEntry{Norman Lists}
...
download_zenodo <- function(doi, 
                           ...
                           ...){
  fs::dir_create(tdir)
  zenodo <- zen4R::ZenodoManager$new(token = token, 
                                     logger = logger)
  ...
  #download
  rec$downloadFiles(path = tdir, files = files, quiet = quiet, ...)
}

print(kwb.utils::isNaOrEmpty(zen4R:::zenodo_pat()))

### Download S90 | ZEROPMBOX1 | ZeroPM Box 1 Substances
### Version: Version NORMAN-SLE-S90.0.1.0 (2021-01-15)
norman_s90_zeropm_path_list <- list(doi = "10.5281/zenodo.5854252", 
                                    tdir = "norman-lists", 
                                    file = "ZeroPM_Box1.csv",
                                    fpath = "<tdir>/<file>")
norman_s90_zeropm_paths <- kwb.utils::resolve(norman_s90_zeropm_path_list)

download_zenodo(doi = norman_s90_zeropm_paths$doi, 
                tdir = norman_s90_zeropm_paths$tdir,
                files = norman_s90_zeropm_paths$file)

#norman_s90_zeropm <- readr::read_csv(norman_s90_zeropm_paths$fpath)


# ### Download S36 | UBAPMT | Potential Persistent, Mobile and Toxic (PMT) substances
# ### Version: NORMAN-SLE-S36.0.2.1 (2020-12-15)
# norman_s36_ubapmt_path_list <- list(doi = "10.5281/zenodo.4323239", 
#                           tdir = "norman-lists",
#                           file = "S36_UBAPMT_Dec2020.csv",
#                           fpath = "<tdir>/<file>")
# norman_s36_ubapmt_paths <- kwb.utils::resolve(norman_s36_ubapmt_path_list)
# 
# download_zenodo(doi = norman_s36_ubapmt_paths$doi, 
#                 tdir = norman_s36_ubapmt_paths$tdir,
#                 files = norman_s36_ubapmt_paths$file)
# 
# norman_s36_ubapmt <- readr::read_csv(norman_s36_ubapmt_paths$fpath)
# 
...
# norman_s0_path_list <- list(doi = "10.5281/zenodo.5873975", 
#                   tdir = "norman-lists",
#                   file = "susdat_2022-01-18-104316.csv",
#                   fpath = "<tdir>/<file>")
# norman_s0_paths <- kwb.utils::resolve(norman_s0_path_list)
# download_zenodo(doi = norman_s0_paths$doi, 
#                 tdir = norman_s0_paths$tdir,
#                 files = norman_s0_paths$file)
# 
# norman_s0 <- readr::read_csv(norman_s0_paths$fpath)
# 
