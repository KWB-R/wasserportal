...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (11.77 secs) 
str(stations)
#> List of 3
...
#>   .. ..$ Datum            : chr [1:36] "24.01.2023 07:00" "28.06.2026 05:00" "28.06.2026 05:00" "27.06.2026" ...
#>   .. ..$ _Durchfluss      : chr [1:36] "0.156" "0.001" "0.560" "0.833" ...
...
#>   .. ..$ Datum            : chr [1:71] "28.06.2026 05:00" "28.06.2026 05:00" "27.10.2025 23:45" "28.06.2026 05:00" ...
#>   .. ..$ Wassertemperatur : chr [1:71] "25.77" "26.34" "10.10" "26.95" ...
...
#>   .. ..$ Klassifikation   : chr [1:71] ">25°C" ">25°C" "inaktiv" ">25°C" ...
...
#>   .. ..$ Datum            : chr [1:18] "28.06.2026 05:00" "28.06.2026 05:00" "27.10.2025 23:45" "28.06.2026 05:00" ...
#>   .. ..$ Leitfaehigkeit   : chr [1:18] "966" "915" "829" "874" ...
...
#>   .. ..$ Betreiber        : chr [1:18] "Land Berlin" "Land Berlin" "Land Berlin" "Land Berlin" ...
#>   .. ..$ Datum            : chr [1:18] "28.06.2026 05:00" "28.06.2026 05:00" "27.10.2025 23:45" "28.06.2026 05:00" ...
#>   .. ..$ pHWert           : chr [1:18] "7.68" "7.35" "7.57" "7.82" ...
...
#>   .. ..$ Klassifikation   : chr [1:18] ">7.5 - 8.0" ">7.0 - 7.5" "inaktiv" ">7.5 - 8.0" ...
...
#>   .. ..$ Betreiber        : chr [1:18] "Land Berlin" "Land Berlin" "Land Berlin" "Land Berlin" ...
#>   .. ..$ Datum            : chr [1:18] "28.06.2026 05:00" "28.06.2026 05:00" "27.10.2025 23:45" "28.06.2026 05:00" ...
#>   .. ..$ Sauerstoffgehalt : chr [1:18] "0.03" "0.00" "8.37" "6.80" ...
...
#>   .. ..$ Gewaesser        : chr [1:18] "Berlin-Spandauer-Schifffahrtskanal" "Spree" "Spree" "Spree" ...
#>   .. ..$ Betreiber        : chr [1:18] "Land Berlin" "Land Berlin" "Land Berlin" "Land Berlin" ...
#>   .. ..$ Datum            : chr [1:18] "27.06.2026 00:00" "27.06.2026 00:00" "27.10.2025 23:45" "27.10.2025 23:45" ...
#>   .. ..$ Parameterwert    : chr [1:18] "27.51" "0.61" "74.55" "" ...
#>   .. ..$ Einheit          : chr [1:18] "%" "%" "%" "%" ...
...
#>   .. ..$ Klassifikation   : chr [1:18] ">25  - 50" "<=25" "inaktiv" "nicht aktuell" ...
...
#>   .. ..$ Datum             : chr [1:56] "07.04.2026 09:12" "05.05.2026 10:54" "05.05.2026 10:32" "05.05.2026 10:03" ...
#>   .. ..$ Entnahmetiefe     : chr [1:56] "0.5 m" "0.5 m" "0.5 m" "0.5 m" ...
#>   .. ..$ Parameterwert     : chr [1:56] "9.5" "17.8" "14.9" "17.0" ...
...
#>   .. ..$ Messstellennummer        : chr [1:891] "1" "2" "3" "4" ...
#>   .. ..$ Bezirk                   : chr [1:891] "Reinickendorf" "Reinickendorf" "Reinickendorf" "Reinickendorf" ...
#>   .. ..$ Auspraegung              : chr [1:891] "GW-Stand" "GW-Stand" "GW-Stand + GW-Güte" "GW-Stand" ...
#>   .. ..$ Grundwasserleiter        : chr [1:891] "Hauptgrundwasserleiter (GWL 1.3 + 2)" "Hauptgrundwasserleiter (GWL 1.3 + 2)" "Hauptgrundwasserleiter (GWL 1.3 + 2)" "Hauptgrundwasserleiter (GWL 1.3 + 2)" ...
#>   .. ..$ Grundwasserspannung      : chr [1:891] "gespannt" "ungespannt" "gespannt" "ungespannt" ...
#>   .. ..$ Datum                    : chr [1:891] "19.06.2026" "19.06.2026" "19.06.2026" "19.06.2026" ...
#>   .. ..$ Grundwasserstand_m_ue_NHN: chr [1:891] "33.48" "34.93" "33.51" "32.46" ...
#>   .. ..$ Flur_abstand_m_u_GOK     : chr [1:891] "keine Angabe" "2.72" "keine Angabe" "7.42" ...
...
#>   .. ..$ Klassifikation           : chr [1:891] "extrem niedrig" "extrem niedrig" "sehr niedrig" "sehr niedrig" ...
...
#>  $ overview_df  :Classes ‘data.table’ and 'data.frame':  1447 obs. of  29 variables:
#>   ..$ key                      : chr [1:1447] "surface_water.water_level" "surface_water.water_level" "surface_water.water_level" "surface_water.water_level" ...
#>   ..$ Messstellennummer        : chr [1:1447] "5865900" "5827103" "5870400" "5865300" ...
#>   ..$ Messstellenname          : chr [1:1447] "Allee der Kosmonauten" "Allendestraße" "Alsenbrücke" "Am Bahndamm" ...
#>   ..$ Gewaesser                : chr [1:1447] "M.-H.-Grenzgr." "Müggelspree" "Griebnitzkanal" "Wuhle" ...
#>   ..$ Betreiber                : chr [1:1447] "Land Berlin" "Land Berlin" "Land Berlin" "Land Berlin" ...
#>   ..$ Datum                    : chr [1:1447] "28.06.2026 05:00" "03.03.2026" "26.06.2026" "25.01.2023 07:00" ...
#>   ..$ Wasserstand              : chr [1:1447] "45.61" "32.30" "29.30" "32.31" ...
#>   ..$ Einheit                  : chr [1:1447] "m+NHN" "m+NHN" "m+NHN" "m+NHN" ...
#>   ..$ Ganglinien               : chr [1:1447] "https://wasserportal.berlin.de/station.php?anzeige=g&thema=ows&station=5865900" "https://wasserportal.berlin.de/station.php?anzeige=g&thema=ows&station=5827103" "https://wasserportal.berlin.de/station.php?anzeige=g&thema=ows&station=5870400" "https://wasserportal.berlin.de/station.php?anzeige=g&thema=ows&station=5865300" ...
#>   ..$ Klassifikation           : chr [1:1447] "niedrig" "inaktiv" "nicht aktuell" "inaktiv" ...
...
#>   ..$ _Durchfluss              : chr [1:1447] NA NA NA NA ...
#>   ..$ Ganglinie                : chr [1:1447] NA NA NA NA ...
#>   ..$ Wassertemperatur         : chr [1:1447] NA NA NA NA ...
#>   ..$ Leitfaehigkeit           : chr [1:1447] NA NA NA NA ...
#>   ..$ pHWert                   : chr [1:1447] NA NA NA NA ...
#>   ..$ Sauerstoffgehalt         : chr [1:1447] NA NA NA NA ...
#>   ..$ Parameterwert            : chr [1:1447] NA NA NA NA ...
#>   ..$ Entnahmetiefe            : chr [1:1447] NA NA NA NA ...
#>   ..$ _Bestimmungsgrenze       : chr [1:1447] NA NA NA NA ...
#>   ..$ Bezirk                   : chr [1:1447] NA NA NA NA ...
#>   ..$ Auspraegung              : chr [1:1447] NA NA NA NA ...
#>   ..$ Grundwasserleiter        : chr [1:1447] NA NA NA NA ...
#>   ..$ Grundwasserspannung      : chr [1:1447] NA NA NA NA ...
#>   ..$ Grundwasserstand_m_ue_NHN: chr [1:1447] NA NA NA NA ...
#>   ..$ Flur_abstand_m_u_GOK     : chr [1:1447] NA NA NA NA ...
#>   ..$ water_body               : chr [1:1447] "surface_water" "surface_water" "surface_water" "surface_water" ...
#>   ..$ variable                 : chr [1:1447] "water_level" "water_level" "water_level" "water_level" ...
#>   ..$ station_type             : chr [1:1447] "ows" "ows" "ows" "ows" ...
#>   ..- attr(*, ".internal.selfref")=<pointer: 0x1021f0270> 
#>  $ crosstable   : tibble [1,114 × 12] (S3: tbl_df/tbl/data.frame)
#>   ..$ Messstellennummer: chr [1:1114] "5865900" "5827103" "5870400" "5865300" ...
#>   ..$ Messstellenname  : chr [1:1114] "Allee der Kosmonauten" "Allendestraße" "Alsenbrücke" "Am Bahndamm" ...
#>   ..$ ows              : chr [1:1114] "x" "x" "x" "x" ...
#>   ..$ odf              : chr [1:1114] NA NA NA "x" ...
#>   ..$ owt              : chr [1:1114] "x" NA "x" "x" ...
#>   ..$ olf              : chr [1:1114] NA NA NA NA ...
#>   ..$ oph              : chr [1:1114] NA NA NA NA ...
#>   ..$ oog              : chr [1:1114] NA NA NA NA ...
#>   ..$ oos              : chr [1:1114] NA NA NA NA ...
#>   ..$ opq              : chr [1:1114] NA NA NA NA ...
#>   ..$ gws              : chr [1:1114] NA NA NA NA ...
#>   ..$ gwq              : chr [1:1114] NA NA NA NA ...
```
