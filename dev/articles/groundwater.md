...
#> Writing 'stations_groundwater_level.csv' ... ok. (0.29 secs) 
...
#> Importing 'groundwater.level' data (1/2) ... ok. (10.41 mins) 
#> Importing 'groundwater.quality' data (2/2) ... ok. (2.17 mins)

files <- wasserportal::list_timeseries_data_to_zip(gw_data_list)
#> Writing 'groundwater_level.zip' ... ok. (11.32 secs) 
