...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (5.48 secs)
str(stations, 2)
#> List of 2
...
[https://kwb-r.github.io/wasserportal/stations_crosstable.json](https://kwb-r.github.io/wasserportal/dev/stations_crosstable.json)
...
#> Importing master data for 889 stations from Wasserportal Berlin ... ok. (5.79 mins)
```
...
format here:
[https://kwb-r.github.io/wasserportal/stations_gwl_master.json](https://kwb-r.github.io/wasserportal/dev/stations_gwl_master.json)
...
48.7 percent of all considered 809 groundwater level monitoring stations
containing `classification` data (out of 889 provided by SenWeb)
indicate `below normal` (extrem niedrig, sehr niedrig, niedrig)
groundwater levels. However, only 48.7 percent are indicate
...
[https://kwb-r.github.io/wasserportal/map_gwl-trend.html](https://kwb-r.github.io/wasserportal/dev/map_gwl-trend.md)
...
[https://kwb-r.github.io/wasserportal/groundwater_level.csv](https://kwb-r.github.io/wasserportal/dev/groundwater_level.csv)
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (1.49 mins)
```

The master data of groundwater quality stations is also available in
JSON format here:
[https://kwb-r.github.io/wasserportal/stations_gwq_master.json](https://kwb-r.github.io/wasserportal/dev/stations_gwq_master.json)
...
here:
[https://kwb-r.github.io/wasserportal/groundwater_quality.csv](https://kwb-r.github.io/wasserportal/dev/groundwater_quality.csv)
