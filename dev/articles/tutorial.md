...
#> Importing 10 station overviews from Wasserportal Berlin ... ok. (6.18 secs)
str(stations, 2)
#> List of 2
...
#> Importing master data for 889 stations from Wasserportal Berlin ... ok. (7.14 mins)
```
...
#> Importing master data for 208 stations from Wasserportal Berlin ... ok. (1.76 mins)
```
