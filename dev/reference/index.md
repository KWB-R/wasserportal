...
- [`base_url_download()`](https://kwb-r.github.io/wasserportal/dev/reference/base_url_download.md)
  : Helper function: base url for download
- [`columns_to_labels()`](https://kwb-r.github.io/wasserportal/dev/reference/columns_to_labels.md)
  : Create Text Labels from Data Frame Columns
- [`get_api_tables()`](https://kwb-r.github.io/wasserportal/dev/reference/get_api_tables.md)
...
- [`get_daily_surfacewater_data()`](https://kwb-r.github.io/wasserportal/dev/reference/get_daily_surfacewater_data.md)
  : Get Daily Surfacewater Data: wrapper to scrape daily surface water
  data
...
- [`get_overview_options()`](https://kwb-r.github.io/wasserportal/dev/reference/get_overview_options.md)
...
- [`get_surfacewater_quality()`](https://kwb-r.github.io/wasserportal/dev/reference/get_surfacewater_quality.md)
...
- [`get_wasserportal_stations()`](https://kwb-r.github.io/wasserportal/dev/reference/get_wasserportal_stations.md)
...
- [`get_wasserportal_variables()`](https://kwb-r.github.io/wasserportal/dev/reference/get_wasserportal_variables.md)
  : Get Names and IDs of the Variables of wasserportal.berlin.de
- [`inspect_gh_pages_zips()`](https://kwb-r.github.io/wasserportal/dev/reference/inspect_gh_pages_zips.md)
  : Download and Inspect Wasserportal ZIP Files Hosted on gh-pages
- [`list_data_to_csv_or_zip()`](https://kwb-r.github.io/wasserportal/dev/reference/list_data_to_csv_or_zip.md)
...
- [`read()`](https://kwb-r.github.io/wasserportal/dev/reference/read.md)
  : Helper function to read CSV
- [`readPackageFile()`](https://kwb-r.github.io/wasserportal/dev/reference/readPackageFile.md)
...
- [`tb_push_station_attributes()`](https://kwb-r.github.io/wasserportal/dev/reference/tb_push_station_attributes.md)
...
- [`wasserportal_base_url()`](https://kwb-r.github.io/wasserportal/dev/reference/wasserportal_base_url.md)
